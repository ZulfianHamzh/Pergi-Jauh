...
import { createProductCombinationAction } from '@/app/admin/actions';
...
export default function NewProductCombinationPage() {
  ...
  const isFormValid = selectedProducts.length > 0 && newProductName.trim() !== '' && newProductPrice.trim() !== '' && newProductPrice > 0;
  ...
  return (
    <div className="min-h-screen bg-[#679CBC] p-6 font-inter">
      <header className="mb-6">
        <h1 className="text-3xl font-bold text-white">Tambah Produk Kombinasi Baru</h1>
      </header>
